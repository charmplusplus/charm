...
{ 
  ...
  device_forward_redirect_handler = CmiRegisterHandler((CmiHandler) device_forward_redirect_bridge);
  _deferredMigrateHandlerIdx = CmiRegisterHandler((CmiHandler) _deferredMigrateHandler);
