...
/* Part needed to be modified for the integration */
        ...
        kmp_critical_name *lck )
{
    ...
    // For the Charm++ Integration, the reduction method using tree is disabled. It might be enabled  in the future if the critical or atomic reduce method incurs significant overhead. 
