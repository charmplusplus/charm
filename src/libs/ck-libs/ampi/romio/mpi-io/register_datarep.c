			 ...
			 void *extra_state)
{
    ...
    for (adio_datarep = ADIO_Global(ADIOI_Datarep_head); adio_datarep; adio_datarep = adio_datarep->next) {
    ...
    adio_datarep->next          = ADIO_Global(ADIOI_Datarep_head);

    ADIO_Global(ADIOI_Datarep_head) = adio_datarep;
