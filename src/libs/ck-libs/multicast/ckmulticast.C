...
//CmiPrintf("init: %d\n", n);
  ...
  CProxy_CkMulticastMgr  mCastGrp(thisgroup);
  // sync call to seup
  cookieMsg *cookiemsg = mCastGrp[CkMyPe()].setup(msg);
  delete cookiemsg;
