...
#ifdef DEBUG_1
  CkPrintf("Chunk %d eating elem %d(%d,%d,%d) in chunk %d\n",idx,FEM_To_ghost_index(localIdx),adjnodes[0],adjnodes[1],adjnodes[2],fromChk);
#endif
  FEM_remove_element(fmMesh,FEM_To_ghost_index(localIdx),0,idx);
