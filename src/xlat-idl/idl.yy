...
%type <ofval>	opt_op_attribute_2
%type <ival>	opt_op_attribute_t
...
operation :
	...
	IDENTIFIER
	{
	  ...
	  UTL_StrList		*p = idl_global->pragmas();
	  int is_threaded = ($1 >= 16);
	  if (is_threaded) $1 = $1 - 16;
	  ...
	  if (s != NULL && $2 != NULL) {
	    AST_Type *tp = AST_Type::narrow_from_decl($2);
	      ...
	      o = idl_global->gen()->create_operation(tp, (AST_Operation::Flags)$1, n, p);
...
/* JJ: We add 16 if the operation is threaded */
opt_op_attribute_t
	: THREADED opt_op_attribute_2
	{
	  $$ = 16 + $2;
	}
	| /* EMPTY */ opt_op_attribute_2
	{
	  $$ = $1;
	}
	;
