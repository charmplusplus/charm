...
void PUP::toPagedDisk::nextblock(){
	pup_list *f;
...
void PUP::toPagedDisk::bytes(void *p,int n,size_t itemSize,dataType) {
...
void PUP::fromPagedDisk::findpageentry(){
...
void PUP::fromPagedDisk::nextblock(){
	if(current_block != -1){
...
void PUP::fromPagedDisk::bytes(void *p,int n,size_t itemSize,dataType ){
