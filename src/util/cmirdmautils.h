...
/* Two-runtime header: reconverse builds get the trimmed declarations that
 * match reconverse's own rdma machinery; classic builds keep mainline's
 * NcpyOperationInfo-based interface. CMK_RECONVERSE comes from
 * charm-config.h (reconverse: 1) / conv-autoconfig.h (classic: 0). */
