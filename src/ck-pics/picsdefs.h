 ...
 *
 *        Version:  1.0
 *        Created:  09/25/2014 12:05:15 PM
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME (), 
...
enum Effect_t { PICS_EFF_PERFGOOD=0, PICS_EFF_GRAINSIZE, PICS_EFF_AGGREGATION, PICS_EFF_COMPRESSION, PICS_EFF_REPLICA, PICS_EFF_LDBFREQUENCY, PICS_EFF_NODESIZE, PICS_EFF_MESSAGESIZE, PICS_EFF_GRAINSIZE_1, PICS_EFF_GRAINSIZE_2, PICS_EFF_UNKNOWN};
