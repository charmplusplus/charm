...
#define CMK_MSG_HEADER_EXT_    CmiInt4 root, size; CmiUInt2 d0,d1,d2,d3,hdl,pn,d4,type,xhdl,info,dd,redID,pad2,rank; CmiUInt1 zcMsgType:4, cmaMsgType:2, nokeep:1;
