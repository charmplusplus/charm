...
#
# $Log$
# Revision 1.1  1998-06-17 17:04:56  rbrunner
...
set CMK_CPP_C='cc +DAportable -Aa -E'
set CMK_CC='cc +DAportable -Aa -D_HPUX_SOURCE '
set CMK_CC_RELIABLE='cc +DAportable -Aa -D_HPUX_SOURCE '
set CMK_CC_FASTEST='cc +DAportable -Aa -D_HPUX_SOURCE '
set CMK_CXX='aCC +DAportable -D_HPUX_SOURCE '
set CMK_CXXPP='aCC +DAportable -D_HPUX_SOURCE -E '
set CMK_CF77=''
set CMK_C_DEBUG='-g'
set CMK_C_OPTIMIZE='+O3 +Onolimit '
set CMK_CXX_DEBUG='-g'
set CMK_CXX_OPTIMIZE='+O3 +Onolimit '
set CMK_LD='cc +DAportable -D_HPUX_SOURCE '
set CMK_LDXX='aCC +DAportable '
set CMK_LD77=''
set CMK_M4='m4'
set CMK_SUF='o'
set CMK_AR='ar q'
...
set CMK_LIBS='-lqt'
set CMK_SEQ_LIBS=''
set CMK_SEQ_CC='cc +DAportable -Aa -D_HPUX_SOURCE '
set CMK_SEQ_LD='cc +DAportable -Aa -D_HPUX_SOURCE '
set CMK_SEQ_CXX='aCC +DAportable -D_HPUX_SOURCE '
set CMK_SEQ_LDXX='aCC +DAportable -D_HPUX_SOURCE '
