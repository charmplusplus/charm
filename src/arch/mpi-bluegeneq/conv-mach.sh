...
CMK_CXX="mpixlcxx_r -qhalt=e $BGQ_INC -qnokeyword=__int128 -qsmp=noostls:noauto"
CMK_GCXX="mpicxx $GCC_OPTS "
CMK_CC="mpixlc_r -qcpluscmt -qhalt=e $BGQ_INC -qnokeyword=__int128 -qsmp=noostls:noauto"
CMK_CXXPP="mpicxx -E "
CMK_CF77="mpixlf77_r "
