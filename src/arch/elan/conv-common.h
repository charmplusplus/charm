...
#define CMK_MSG_HEADER_BLUEGENE    { unsigned char type, rank; CmiUInt2 root, hdl,xhdl,info,d3; int nd, n; double rt; CmiInt2 tID; CmiUInt2 hID; char t; int msgID; int srcPe;}
