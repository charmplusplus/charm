...
#define CMK_MSG_HEADER_EXT_    CmiUInt2 rank, hdl,xhdl,info, redID; CmiInt4 root; unsigned char cksum, magic, mpiMsgType; CmiUInt1 zcMsgType:3, cmaMsgType:2, nokeep:1, msgLayerType:1, commSender:1, networkMsg:1; CmiInt4 uniqMsgId; CmiUInt4 msgSrcPe, msgSrcNode;
#else
