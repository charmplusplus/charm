...
#define CMK_MSG_HEADER_EXT    { CmiUInt2 rank, root, hdl,xhdl,info,cksum; }
#define CMK_MSG_HEADER_BLUEGENE    { CmiUInt2 rank, root, hdl,xhdl,info,cksum; int nd, n; double rt; CmiInt2 tID; CmiUInt2 hID; char t; int msgID; int srcPe;}
