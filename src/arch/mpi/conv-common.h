...
#define CMK_MSG_HEADER_EXT_    CmiUInt2 rank, hdl,xhdl,info, type, redID; CmiInt4 root; unsigned char cksum, magic;
#else
#define CMK_MSG_HEADER_EXT_    CmiUInt2 rank, hdl,xhdl,info, type, redID; CmiInt4 root; 
#endif
