...
CMK_CPP_C="clang -arch x86_64 -m64 -fPIC -E -mmacosx-version-min=10.6 "
CMK_CC="clang -arch x86_64 -m64 -dynamic -fno-common -mmacosx-version-min=10.6 $CMK_DEFS "
CMK_LD="clang -mmacosx-version-min=10.6 "
CMK_CXX="clang++ -arch x86_64 -m64 -fPIC -dynamic -fno-common -mmacosx-version-min=10.6 $CMK_DEFS "
CMK_CXXPP="clang++ -arch x86_64 -m64 -x clang++ -E -mmacosx-version-min=10.6 "
