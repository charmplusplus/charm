...
CMK_LD="$CMK_CC -rdynamic -pthread -WI,-rpath,/usr/local/vmi-2.1.0-1-gcc/lib $VMI_LIBDIR "
#CMK_LDXX="$CMK_CXX -rdynamic -pthread $VMI_LIBDIR"
CMK_LDXX="$CMK_CXX -rdynamic -pthread -WI,-rpath,/usr/local/vmi-2.1.0-1-gcc/lib $VMI_LIBDIR"
CMK_RANLIB='ranlib'
