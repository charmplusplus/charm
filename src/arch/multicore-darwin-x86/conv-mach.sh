...
CMK_CPP_C="clang -m32 -fPIC -E -mmacosx-version-min=10.7 "
CMK_CC="clang -m32 -dynamic -fno-common -mmacosx-version-min=10.7 $CMK_DEFS "
CMK_LD="clang -m32 -mmacosx-version-min=10.7 -Wl,-no_pie "
CMK_CXX="clang++ -m32 -fPIC -dynamic -fno-common -mmacosx-version-min=10.7 $CMK_DEFS "
CMK_CXXPP="clang++ -m32 -x clang++ -E -mmacosx-version-min=10.7 "
CMK_LDXX="$CMK_CXX -m32 -multiply_defined suppress -mmacosx-version-min=10.7 -Wl,-no_pie $CMK_DEFS "
CMK_XIOPTS=""
