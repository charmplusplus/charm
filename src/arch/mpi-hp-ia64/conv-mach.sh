...
CMK_SEQ_CC="mpicc -D_HPUX_SOURCE $CMK_INCDIR "
CMK_SEQ_LD="mpicc -D_HPUX_SOURCE $CMK_LIBDIR "
CMK_SEQ_CXX="mpiCC -w -D_HPUX_SOURCE $CMK_INCDIR "
CMK_SEQ_LDXX="mpiCC -w -D_HPUX_SOURCE $CMK_LIBDIR "
CMK_CF77="mpif77"
CMK_CF90="mpif90"
CMK_CPP_SUFFIX="i"
