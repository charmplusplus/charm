...
check_function_exists(pthread_getaffinity_np HAVE_DECL_PTHREAD_GETAFFINITY_NP)
check_function_exists(pthread_setaffinity_np HAVE_DECL_PTHREAD_SETAFFINITY_NP)
check_function_exists(pthread_setaffinity_np CMK_HAS_PTHREAD_SETAFFINITY)
...
foreach (v ${_variableNames})
    if(("${v}" MATCHES "^CMK_" OR "${v}" MATCHES "^HAVE_" OR "${v}" MATCHES "^SIZEOF_" OR "${v}" MATCHES "^CHARM_") AND NOT "${v}" MATCHES "_CODE$")
