...
set CMK_CF77=''
set CMK_C_DEBUG='-g'
set CMK_C_OPTIMIZE='-O3 -r10000 -INLINE:all -IPA -TARG:platform=ip27 -OPT:Olimit=0:roundoff=3:div_split=ON:alias=typed '
set CMK_CXX_DEBUG='-g'
set CMK_CXX_OPTIMIZE='-O3 -r10000 -INLINE:all -IPA -TARG:platform=ip27 -OPT:Olimit=0:roundoff=3:div_split=ON:alias=typed '
set CMK_LD='cc -64 -w '
