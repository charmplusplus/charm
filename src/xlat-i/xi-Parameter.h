...
class Parameter {
 ...
 public:
    ...
    void pupRdma(XStr &str, int regArray);
    ...
    void marshallRdmaParameters(XStr &str, int opts);
  ...
  public:
    ...
    void print(XStr &str,int withDefaultValues=0,int useConst=1, bool rdmaPost=false);
...
class ParamList {
    ...
    typedef void (Parameter::*rdmafn_t)(XStr &str, int opts);
    void callEach(fn_t f,XStr &str);
    void callEach(rdmafn_t f,XStr &str, int opts);
  ...
  public:
    ...
    void beginRdmaWrapperUnmarshall(XStr &str);
    void unmarshall(XStr &str, int isFirst=1, int opts=0);
