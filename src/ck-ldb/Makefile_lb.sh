#!/bin/sh
LOADBALANCERS="DummyLB ComboCentLB RandCentLB RefineLB RefineCommLB GreedyLB GreedyCommLB Comm1LB OrbLB RecBisectBfLB MetisLB RotateLB NeighborLB NeighborCommLB WSLB"
