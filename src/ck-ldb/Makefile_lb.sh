#!/bin/sh
LOADBALANCERS="DummyLB ComboCentLB RandCentLB RefineLB RefineCommLB GreedyLB GreedyCommLB GreedyAgentLB Comm1LB OrbLB RecBisectBfLB MetisLB RotateLB NeighborLB NeighborCommLB WSLB GridCommLB"
