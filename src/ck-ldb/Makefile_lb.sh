#!/bin/sh
LOADBALANCERS="DummyLB ComboCentLB RandCentLB RecBisectBfLB MetisLB RefineLB RefineCommLB GreedyCommLB Comm1LB GreedyLB NeighborLB GreedyRefLB OrbLB RandRefLB WSLB"
