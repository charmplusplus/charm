#!/bin/sh
LOADBALANCERS="DummyLB ComboCentLB RandCentLB RecBisectBfLB MetisLB RefineLB RefineCommLB GreedyCommLB Comm1LB GreedyLB NeighborLB NeighborCommLB GreedyRefLB OrbLB RandRefLB WSLB"
