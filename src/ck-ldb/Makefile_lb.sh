#!/bin/sh
ALL_LDBS="BlockLB ComboCentLB Comm1LB DummyLB GraphPartLB GreedyAgentLB GreedyCommLB GreedyLB GridCommLB GridCommRefineLB GridHybridLB GridHybridSeedLB GridMetisLB HbmLB HybridLB MetisLB NeighborCommLB NeighborLB OrbLB PhasebyArrayLB RandCentLB RecBisectBfLB RefineLB RefineCommLB RefineKLB RefineTopoLB RotateLB TopoCentLB TopoLB WSLB"
COMMON_LDBS="BlockLB Comm1LB DummyLB GreedyAgentLB GreedyCommLB GreedyLB NeighborCommLB NeighborLB OrbLB PhasebyArrayLB RandCentLB RecBisectBfLB RefineLB RefineCommLB RotateLB"
