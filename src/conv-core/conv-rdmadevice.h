...
/* Two-runtime header (same pattern as cmirdmautils.h): the reconverse side
 * carries the hapi-portable device-comm interface; classic keeps mainline's
 * CUDA declarations. CMK_RECONVERSE comes from charm-config.h. */
