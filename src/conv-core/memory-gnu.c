/* 
Off-the-shelf glibc 2.3.2 malloc routine: useful because it's
...
#define attribute_hidden /* empty, needed by memory-gnu.h */

#if 0 /* fixes from 2.2.5 version (now obsolete) */
