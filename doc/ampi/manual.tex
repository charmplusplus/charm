...
MPI-2.2 standard\footnote{Currently, the MPI-3.1 standard is under active development,
though we already support non-blocking and neighborhood collectives.} on top of \charmpp{}.
\charmpp{} is a \CC{}-based parallel programming library being developed by Prof.
...
four VPs per each PE). Figure \ref{fig_prac} show how the problem domain
