...
selected by default using the obvious rule (e.g., if the input file if
...
If this follows {\tt -optimize} on the command line, it turns optimization back off.
This can be used to override options specified in makefiles.
...
a virtual topology for constructing neighbors during run-time using
