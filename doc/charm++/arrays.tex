...
\item \bf{Method 1}: By default, the array elements may be asked to migrate at any time
...
\item \bf{Method 2}: Using the AtSync method, elements can be migrated at certain
...
\item \bf{ Method 3}: The load balancer can be programmed to be started
manually. 
 To use this feature, the LBDatabase object
can be got explicitly by making the call \kw{LBDatabase::Object()}
For example, 

\kw{LBDatabase * myLbdb = LBDatabase::Object()}
