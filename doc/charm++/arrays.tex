...
In the multicast example above, number of section members of the messages are 
...
To use section reduction, you need to first register a reduction callback to
