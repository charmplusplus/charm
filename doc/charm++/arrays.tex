...
%
\begin{alltt}
CProxy_ArrayA a1 = CProxy_ArrayA::ckNew(\uw{parameters}, dimX);
\end{alltt}
%
...
%
\begin{alltt}
CProxy_ArrayB a2 = CProxy_ArrayB::ckNew(\uw{parameters}, dimX, dimY);
CProxy_ArrayC a3 = CProxy_ArrayC::ckNew(\uw{parameters}, dimX, dimY, dimZ);
\end{alltt}
%
...
\item \kw{CkReduction::bitvec\_xor} : the result will be the bitvector XOR of the given numbers (represented as integers).
