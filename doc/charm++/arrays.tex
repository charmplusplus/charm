...
information on the \kw{ArrayElementMigrateMessage}
constructor. 
...
unpacking of the data items is done in the element's \kw{pup} routine.
...
It may be more convenient, however, to inherit from \kw{ArrayElementT<foo>}, 
