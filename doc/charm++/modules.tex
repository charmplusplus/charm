...
\section{Charm++ Interface (.ci) Files}
\index{ci}
...
declaring them in separate \emph{charm++ interface} description
...
\subsection{Syntax Highlighting of .ci Files}
...
Syntax highlighting in Sublime Text (version 3 or newer) can be enabled by
installing the \emph{Charmci} package through Package Control.
...
can have several modules. Modules are specified using the keyword \kw{module}. A 
