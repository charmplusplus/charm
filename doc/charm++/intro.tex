...
possibly on other processors, which can simultaniously work to solve the
problem at hand.
...
development of emerging applications fo parallel processing.  The earliest
...
retargetted on top on {\sc Converse}, and popular programming paradigms such as
