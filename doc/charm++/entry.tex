...
an entry method:
\kw{threaded}, \kw{sync}, \kw{exclusive}, \kw{nokeep}, \kw{notrace}, \kw{appwork}, \kw{immediate}, \kw{expedited}, \kw{scatterv}, \kw{inline}, \kw{local}, \kw{python}.
...
\index{scatterv}\item[scatterv] entry methods contain a single array parameter 
...
can be found in \examplerefdir{scatterv}.
