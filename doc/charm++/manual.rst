...
header, because of the inherent complexities of C++. Also, ``break`` and
``continue`` statements are not supported within SDAG loops, either
within ``serial`` blocks or otherwise.
