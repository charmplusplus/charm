...
\item {\bf MetisLB}:
Uses \href{http://glaros.dtc.umn.edu/gkhome/metis/metis/overview}{METIS\texttrademark\hspace{0mm}}
to partition the object communication graph.
\item {\bf ScotchLB}:
Uses the \href{http://www.labri.fr/perso/pelegrin/scotch/}{SCOTCH}
library for partitioning the object communication graph, while also taking
...
+LBNumMoves},which specifies the percentage of migrations that can be
tolerated.
