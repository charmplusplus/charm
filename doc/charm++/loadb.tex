...
When you don't activate any of load balancers at compile time or run time, 
...
automatically created in this case which does nothing 
but call {\em ResumeFromSync()} after {\em AtSync()}. 
This is to keep a program from hanging after calling {\em AtSync()}.
