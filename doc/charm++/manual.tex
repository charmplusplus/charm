...
\usepackage{../pplmanual} \input{../pplmanual}
\usepackage{listings}
\usepackage{textcomp}
...
\chapter{Collectives}
  \input{reductions}
%  \input{alltoall} TO BE UPDATED WITH NDMESHSTREAMER INTERFACE
...
\index{Malleability: Shrink/Expand Number of Processors}
