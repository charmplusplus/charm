...
restore for the application. One illustration of this flexibility is a
...
in the code. When it is called by a processor, the processor will hang and stop responding to any communication.
