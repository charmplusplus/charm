...
A \term{shared entity} is a boundary entity that two or more chunks 
...
The geometric symmetry layer in the preceding section is actually
...
\function{SUBROUTINE FEM\_Get\_elem(elType,nEl,doublePerEl,nodePerEl)}
  ...
  \args{INTEGER, INTENT(OUT) :: nEl,doublePerEl,nodePerEl}
     ...
     Describe/retrieve the number and type of elements.  \kw{ElType} is a
