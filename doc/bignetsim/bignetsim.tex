...
\function{int selectRoute(int current, int dest, int numP, Topology* top, Packet *p, map\textless int,int\textgreater{} \&bufsize, unsigned short *xsubi)}
\index{selectRoute}
...
\function{int selectRoute(int current, int dest, int numP, Topology* top, Packet *p, map\textless int,int\textgreater{} \&bufsize, map\textless int,int\textgreater{} \&portContention, unsigned short *xsubi)}
...
\function{int selectInputVc(map\textless int,int\textgreater{} \&availBuffer, map\textless int,int\textgreater{} \&request, map\textless int,vector\textless Header\textgreater{} \textgreater{} \&inBuffer, int globalVc, int curSwitch)}
\index{selectInputVc}
...
\function{int selectOutputVc(map\textless int,int\textgreater{} \&bufsize, Packet *p, int unused)}
