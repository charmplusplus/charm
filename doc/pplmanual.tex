...
\begin{htmlonly}
\renewcommand{\examplereffile}[1]{{\tt\emph{examples/charm++/#1}}}
\renewcommand{\examplerefdir}[1]{{\tt examples/charm++/#1}}
\renewcommand{\testreffile}[1]{{\tt\emph{tests/charm++/#1}}}
\renewcommand{\testrefdir}[1]{{\tt tests/charm++/#1}}
\end{htmlonly}
\makeindex
