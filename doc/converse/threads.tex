...
contents of a CthThreadStruct, {\it except} that it {\it does} include a
converse header, so you may call {\tt CmiSetHandler} on a {\tt CthThread}
and subsequently enqueue the thread in the {\tt CsdScheduler} queue.}
...
function (see {\tt CthSetStrategy} below).}
