...
wants the CPU using the {\tt awakefn}").  If a thread is a part of the
scheduling module, it is permitted for it to short-circuit the {\tt
awakefn}: presumably, the scheduling module has other means of knowing
