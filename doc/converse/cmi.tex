...
processors and querying node information. These are discussed in Section~\ref{globalvars}.
...
\note{
Before calling this function, the program needs to initialize the system
...
This function is used to delete either the data structure passed in as first
...
ID, and it is up to the user to distribute this ID to any processor that needs
it.}
...
to  inquire about the status of this operation.}
...
which could be used to  inquire about the status of this operation.}
}
...
\desc{Creates a processor-group with calling processor as the root processor.}
