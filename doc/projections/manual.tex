...
specified events. User events are usually displayed in the Timeline view as short vertical bars above the entry methods. Alternatively the user event can be displayed as a vertical bar that vertically spans all timelines. Follow these following basic steps for creating user events in a charm++ program:
...
There are two types of user events, differentiated by the call used to generate each:
