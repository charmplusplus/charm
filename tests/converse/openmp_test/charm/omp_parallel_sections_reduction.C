...
int TestInstance::<ompts:testcode:functionname>omp_parallel_sections_reduction</ompts:testcode:functionname>(){
	<ompts:orphan:vars>
    int sum;
	int known_sum;	
	double dpt;
...
#pragma omp section
	...
	{
		result++;
		CkPrintf("Error in sum with integers: Result was %d instead of %d.\n",sum, known_sum);
	}
...
#pragma omp section
	...
	{
		result++;
		CkPrintf("Error in Difference with integers: Result was %d instead of 0.\n",diff);
	}
	for (i=0;i<20;++i)
	{
		dpt*=dt;
...
#pragma omp section
	...
	{
		result++; 
		CkPrintf("Error in sum with doubles: Result was %f instead of %f (Difference: %E)\n",dsum,dknown_sum, dsum-dknown_sum);
	}
...
#pragma omp section
	...
	{
		result++;
		CkPrintf("Error in Difference with doubles: Result was %E instead of 0.0\n",ddiff);
	}
...
#pragma omp section
	...
	{
		result++;
		CkPrintf("Error in Product with integers: Result was %d instead of %d\n",product,known_product);
	}
...
#pragma omp section
	...
	{
		result++;
		CkPrintf("Error in logic AND part 1\n");
	}
...
#pragma omp section
	...
	{
		result++;
		CkPrintf("Error in logic AND part 2");
	}
...
#pragma omp section
	...
	{
		result++;
		CkPrintf("Error in logic OR part 1\n");
	}
...
#pragma omp section
	...
	{
		result++;
		CkPrintf("Error in logic OR part 2\n");
	}
...
#pragma omp section
	...
	{
		result++;
		CkPrintf("Error in BIT AND part 1\n");
	}
...
#pragma omp section
	...
	{
		result++;
		CkPrintf("Error in BIT AND part 2");
	}
...
#pragma omp section
	...
	{
		result++;
		CkPrintf("Error in BIT OR part 1\n");
	}
	bit_or = 0;
	logics[501]=1;
...
#pragma omp section
	...
	{
		result++;
		CkPrintf("Error in BIT OR part 2\n");
	}
...
#pragma omp section
	...
	{
		result++;
		CkPrintf("Error in EXCLUSIV BIT OR part 1\n");
	}
...
#pragma omp section
	...
	{
		result++;
		CkPrintf("Error in EXCLUSIV BIT OR part 2\n");
	}
</ompts:orphan>
	/*printf("\nResult:%d\n",result);*/
	return (result==0);
