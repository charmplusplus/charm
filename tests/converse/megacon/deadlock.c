...
void deadlock_moduleinit() {
  ...
  symbolTableFnArrayRegister(CpvAccess(deadlock_inc_idx), 1, makeIncSymbolTableInfo,
                             getInd);
  symbolTableFnArrayRegister(CpvAccess(deadlock_cram_idx), 1, makeCramSymbolTableInfo,
                             getInd);
