...
for node_count in node_count_list:
  ...
  h_total_avg = statistics.mean(h_total_times)
  h_total_stdev = statistics.stdev(h_total_times)
  h_comm_avg = statistics.mean(h_comm_times)
  h_comm_stdev = statistics.stdev(h_comm_times)
  d_total_avg = statistics.mean(d_total_times)
  d_total_stdev = statistics.stdev(d_total_times)
  d_comm_avg = statistics.mean(d_comm_times)
  d_comm_stdev = statistics.stdev(d_comm_times)
