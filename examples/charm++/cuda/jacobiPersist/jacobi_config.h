...
#define NUM_ROWS      256 //128  // 58  // The number of data rows each chare has
#define NUM_COLS      254 //130  // 62  // The number of data columns each chare
//#has (vectorized code used on SPE if this is a '(multiple of 4) +/- 2')
#define NUM_CHARES    32  // 24  // The number of chares (per dimension)

#define MAX_ERROR  0.00006f // 0.0001f  // The value that all errors have to be below for the program to finish
