...
class Jacobi : public CBase_Jacobi {
  ...
  private:
    ...
    float* tmpMaxError; // Pointer to a temp buffer used to calculate "local" maxDiff values in the doCalculation AEM

    float* northGhostData;
    float* southGhostData;
    float* eastGhostData;
    float* westGhostData;
    float* northGhostDataOut;
    float* southGhostDataOut;
    float* eastGhostDataOut;
    float* westGhostDataOut;
